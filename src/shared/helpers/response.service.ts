...
export class ResponseService {
  ...
  private responseData(req, msgCode, status, items, total: any = 0, lang: string = 'EN', state = {}, summary = null) {
  ...
  public responseFindOneSuccess(req: any, res: any, items: any, total: number = 1, lang: string = "TH") {
    return res.status(HttpStatus.OK)
      .json(
        this.responseData(req, 100, HttpStatus.OK, items, total, lang)
      )
  }
